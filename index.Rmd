...
author: "[Flávia Alves](https://flaviaalves-profmat.github.io) | PROFMAT"
...
Acesse: [Flávia Alves](info/index.html){target="_blank"}

# Página dos alunos da disciplina

- Acesse: [Página dos alunos da disciplina MA 41 (PROFMAT)](https://flaviaalves-profmat.github.io/profmatma41/){target="_blank"}

# Visão geral sobre os relatórios {.tabset .tabset-fade}

Este projeto está disponível em <https://github.com/flaviaalves-profmat/profmatma41.git>.
...
- [Relatório 01 (25/08/2026)](rel01/index.html){target="_blank"}
